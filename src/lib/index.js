...
export const ALLOWED_BACKGROUND_MEDIA_TYPES = [ 'video', 'image' ];

export const DEFAULT_COLORS = [
	{ name: 'Pale pink', color: '#f78da7' },
	...
	{ name: 'Vivid cyan blue', color: '#0693e3' },
	{ name: 'Very light gray', color: '#eee' },
	{ name: 'Cyan bluish gray', color: '#abb8c3' },
	{ name: 'Very dark gray', color: '#313131' },
];
